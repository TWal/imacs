...
urlpatterns = [
    ...
    path('task_list/<int:task_list_id>/completions', views.TaskListCompletions.as_view(), name='task_list_completions'),
    ...
    path('task/<int:task_id>/task_me', views.TaskTaskMe.as_view(), name='task_task_me'),
    path('task/<int:task_id>/delete', views.TaskDelete.as_view(), name='task_delete'),
    path('task/<int:task_id>/add_done_now/<str:next>', views.TaskDoneAddNow.as_view(), name='task_done_add_now'),
